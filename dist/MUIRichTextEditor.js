...
var MUIRichTextEditor = function (props, ref) {
    ...
    var isMaxLengthHandled = function (editorState, nextLength) {
        var currentLength = editorState
            .getCurrentContent()
            .getPlainText("").length;
        return (0, utils_1.isGreaterThan)(currentLength + nextLength, props.maxLength)
            ? "handled"
            : "not-handled";
    };
    ...
    return (react_1.default.createElement("div", { id: editorId + "-root", className: classes.root },
        react_1.default.createElement("div", { id: editorId + "-container", className: (0, classnames_1.default)(classes.container, (_b = {},
                ...
                _b)) },
            props.autocomplete && autocompletePositionRef.current ? (react_1.default.createElement(Autocomplete_1.default, { items: getAutocompleteItems(), top: autocompletePositionRef.current.top, left: autocompletePositionRef.current.left, onClick: handleAutocompleteSelected, selectedIndex: selectedIndex })) : null,
            props.inlineToolbar && editable && state.toolbarPosition ? (react_1.default.createElement(material_1.Paper, { className: classes.inlineToolbar, style: {
                    top: state.toolbarPosition.top,
                    left: state.toolbarPosition.left,
                } },
                react_1.default.createElement(Toolbar_1.default, { id: editorId, editorState: editorState, onClick: handleToolbarClick, controls: inlineToolbarControls, customControls: customControls, inlineMode: true, isActive: true }))) : null,
            renderToolbar ? (react_1.default.createElement(Toolbar_1.default, { id: editorId, editorState: editorState, onClick: handleToolbarClick, controls: controls, customControls: customControls, className: classes.toolbar, disabled: !editable, size: props.toolbarButtonSize, isActive: focus })) : null,
            placeholder,
            ...
            state.anchorUrlPopover ? (react_1.default.createElement(UrlPopover_1.default, { data: state.urlData, anchor: state.anchorUrlPopover, onConfirm: handleConfirmPrompt, isMedia: state.urlIsMedia })) : null)));
};
exports.default = (0, mui_1.withStyles)((0, react_1.forwardRef)(MUIRichTextEditor), function (theme) {
