            ...
            react_1.default.createElement(Grid_1.default, { container: true, spacing: 1 },
                react_1.default.createElement(Grid_1.default, { container: true, item: true, xs: true, spacing: 1 },
                    react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
                        react_1.default.createElement(TextField_1.default, { className: classes.linkTextField, onChange: function (event) {
                                return setData(__assign(__assign({}, data), { url: event.target.value }));
                            }, label: "URL", defaultValue: props.data && props.data.url, autoFocus: true, InputLabelProps: {
                                shrink: true,
                            } })),
                    props.isMedia ? (react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
                            react_1.default.createElement(ButtonGroup_1.default, { fullWidth: true },
                                react_1.default.createElement(Button_1.default, { color: !data.type || data.type === "image"
                                        ? "primary"
                                        : "inherit", size: "small", onClick: function () { return setData(__assign(__assign({}, data), { type: "image" })); } },
                        ...
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 6 },
                            react_1.default.createElement(TextField_1.default, { onChange: function (event) {
                                    return onSizeChange(event.target.value, "width");
                                }, value: data.width || "", label: "Width", InputLabelProps: {
                                    shrink: true,
                                } })),
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 6 },
                            react_1.default.createElement(TextField_1.default, { onChange: function (event) {
                                    return onSizeChange(event.target.value, "height");
                                }, value: data.height || "", label: "Height", InputLabelProps: {
                                    shrink: true,
                                } })),
                        react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
                            react_1.default.createElement(ButtonGroup_1.default, { fullWidth: true },
                                ...
                                react_1.default.createElement(Button_1.default, { color: data.alignment === "right" ? "primary" : "inherit", size: "small", onClick: function () { return setData(__assign(__assign({}, data), { alignment: "right" })); } },
                                    react_1.default.createElement(FormatAlignRight_1.default, null)))))) : null),
                react_1.default.createElement(Grid_1.default, { container: true, item: true, xs: 12, direction: "row", justifyContent: "flex-end" },
                    props.data && props.data.url ? (react_1.default.createElement(Button_1.default, { onClick: function () { return props.onConfirm(props.isMedia, ""); } },
                        react_1.default.createElement(DeleteOutline_1.default, null))) : null,
                    react_1.default.createElement(Button_1.default, { onClick: function () {
                            return props.onConfirm(props.isMedia, data.url, data.width, data.height, data.alignment, data.type);
                        } },
